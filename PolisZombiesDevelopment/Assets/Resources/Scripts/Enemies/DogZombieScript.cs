...
public class DogZombieScript : ZombieScript
{
    public float health;
    ...
    void Start()
    {
        ...
        else if(waveThis < 11) {GetComponent<AIPath>().maxSpeed = 3.75f;}
        else if(waveThis < 16) {GetComponent<AIPath>().maxSpeed = 4f;}
        else {GetComponent<AIPath>().maxSpeed = 4.5f;}
    }
