...
public class BomberZombieScript : ZombieScript
{
    [SerializeField] float health;
    public PlayerScript playerScript;
    public GameObject bomberZombieExplosion;
    ...
    private void Die()
    {
        ...
        {
            hasDied = true;
            Instantiate(bomberZombieExplosion, transform.position, Quaternion.identity);
            Destroy(gameObject);
        }
    }
