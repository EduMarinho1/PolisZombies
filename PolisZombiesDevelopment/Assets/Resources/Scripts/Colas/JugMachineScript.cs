...
public class JugMachineScript : MonoBehaviour
{
    public int price;
    ...
    {
        if (other.gameObject.name == "Player" && !other.GetComponent<PlayerScript>().HasCola("Jug") &&
             ...
             && timeSinceLastBuy >= timeBetweenBuy)
        {
            ...
            other.GetComponent<PlayerScript>().AddCola("Jug");
...
void OnTriggerEnter2D(Collider2D other)
{
    if (other.gameObject.tag == "Player")
    {
        ...
        purchaseLabel.GetComponent<TextMeshProUGUI>().text = "purchase cola (" + price + "): Increase health";
    }
}
