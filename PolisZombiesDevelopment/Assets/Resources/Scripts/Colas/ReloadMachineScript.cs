...
public class ReloadMachineScript : MonoBehaviour
{
    public int price;
    ...
    {
        if (other.gameObject.name == "Player" && !other.GetComponent<PlayerScript>().HasCola("Reload") &&
             ...
             && timeSinceLastBuy >= timeBetweenBuy)
        {
            ...
            other.GetComponent<PlayerScript>().AddCola("Reload");
...
void OnTriggerEnter2D(Collider2D other)
{
    if (other.gameObject.tag == "Player")
    {
        ...
        purchaseLabel.GetComponent<TextMeshProUGUI>().text = "purchase cola (" + price + "): Faster reload";
    }
}
