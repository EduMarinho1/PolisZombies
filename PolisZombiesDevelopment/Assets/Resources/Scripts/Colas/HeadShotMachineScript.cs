...
public class HeadShotMachineScript : MonoBehaviour
{
    public int price;
    ...
    {
        if (other.gameObject.name == "Player" && !other.GetComponent<PlayerScript>().HasCola("HeadShot") &&
             ...
             && timeSinceLastBuy >= timeBetweenBuy)
        {
            ...
            other.GetComponent<PlayerScript>().AddCola("HeadShot");
...
void OnTriggerEnter2D(Collider2D other)
{
    if (other.gameObject.tag == "Player")
    {
        ...
        purchaseLabel.GetComponent<TextMeshProUGUI>().text = "purchase cola (" + price + "): Critical chance";
    }
}
