...
public class MoneyMachineScript : MonoBehaviour
{
    public int price;
    ...
    {
        if (other.gameObject.name == "Player" && !other.GetComponent<PlayerScript>().HasCola("Pina") &&
             ...
             && timeSinceLastBuy >= timeBetweenBuy)
        {
            ...
            other.GetComponent<PlayerScript>().AddCola("Pina");
...
void OnTriggerEnter2D(Collider2D other)
{
    if (other.gameObject.tag == "Player")
    {
        ...
        purchaseLabel.GetComponent<TextMeshProUGUI>().text = "purchase cola (" + price + "): Earn more money per hit";
    }
}
