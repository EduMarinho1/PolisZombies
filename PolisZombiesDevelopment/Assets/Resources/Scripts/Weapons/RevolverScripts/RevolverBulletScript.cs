...
public class RevolverBulletScript : BulletScript
{
    ...
    void OnTriggerEnter2D(Collider2D collision) 
    {
        ...
        {
            hitEnemy = true;
            enemyComponent.TakeDamage(GameObject.Find("Revolver").GetComponent<WeaponScript>().damage);
            player = GameObject.FindGameObjectWithTag("Player");
            player.GetComponent<PlayerScript>().AddMoney(5);
